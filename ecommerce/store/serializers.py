...
):  # Changed to serializers.Serializer as it's not directly tied to OrderItem model save here
    product_id = serializers.CharField(
        max_length=255
    )  # Assuming product ID is a string (UUID)
