    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['phone'], name='payment_tra_phone_e7401d_idx'), models.Index(fields=['status'], name='payment_tra_status_373de7_idx'), models.Index(fields=['-created_at'], name='payment_tra_created_7fbad7_idx')],
            },
        ),
    ]
