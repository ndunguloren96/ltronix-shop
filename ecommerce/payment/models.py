...
class Transaction(models.Model):
    ...
    is_callback_received = models.BooleanField(default=False,
    ...
    def mark_completed(self, mpesa_receipt=None, result_code=None, result_desc=None):
        ...
        if self.order and not self.order.complete:
            ...
            self.order.transaction_id = self.mpesa_receipt_number # Use Mpesa receipt as transaction_id
            self.order.save()
            print(f"Order {self.order.id} marked as complete and transaction_id set to {self.mpesa_receipt_number}")
