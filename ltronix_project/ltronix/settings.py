"""
Django settings for ltronix project.
...
WSGI_APPLICATION = "ltronix.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": "ltronix_db",  # Ensure this matches your database name
        "USER": "ltronix_user",  # Ensure this matches your database username
        "PASSWORD": "962204",  # Ensure this matches your database password
        "HOST": "localhost",  # Ensure the database is running on localhost
