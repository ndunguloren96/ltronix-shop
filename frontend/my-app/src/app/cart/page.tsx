...
export default function CartPage() {
  ...
  return (
    <Box p={{ base: 4, md: 8 }} maxWidth="container.xl" mx="auto" minH="80vh">
      <Heading as="h1" size="xl" textAlign="center" mb={{ base: 6, md: 8 }} color="gray.800">
        Your Shopping Cart
      </Heading>

      {status === 'unauthenticated' && (
        <Alert status="info" mb={6} borderRadius="md" variant="subtle">
          <AlertIcon />
          <AlertDescription>
              ...
              >
                <HStack spacing={{ base: 2, md: 4 }} align="center" flexWrap="wrap">
                  ...
                  <Box flex={{ base: 1, md: 1 }} minW="150px">
                    <Text fontWeight="bold" fontSize={{ base: "md", md: "lg" }} noOfLines={2}>
                      {item.name}
                    </Text>
                  ...
                  <Text fontWeight="semibold" textAlign="right" minW="80px">
